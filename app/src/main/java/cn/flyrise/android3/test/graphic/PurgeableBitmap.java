 ...
 */
public class PurgeableBitmap extends Activity {
    ...
    private boolean detectIfPurgeableRequest() {
        ...
        if (!components[components.length - 1].contains("NonPurgeable")) {
            Log.e("Test", components[components.length - 1]+"=====true");
            return true;
        } else {
            Log.e("Test", components[components.length - 1]+"=====false");
            return false;
        }
    }
